...
const houseExpanded = document.querySelector(".house-content--expanded");
const houseCentered = document.querySelector(".house-content__image--centered");
...
const whyUsSection = document.querySelector(".benefits-house");
